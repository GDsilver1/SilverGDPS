...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    const LOADING_MESSAGES = [
      ...
      "Braen was here",
      "Silver>Gold",
      "I bet you haven't beaten Bloodbath",
      "Sonion",
      "RIP Triple T 🙏🙏",
      "join my discord pretty pleasre v🙏🙏🙏",
      "asldkjasl i have so much control!!!! dkfjdl",
      "i love maine",
      "get back to your schoolwork 😔😔😔",
      "yo what happens if i type here",
      "the f student IS the inventor 🥹🥹",
      "w game 😭😭",
      "😭😭",
      "🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤🤤",
    ];
